...
docker run --name cwl_postgres -e POSTGRES_PASSWORD=postgres -p 5432:5432 -v c:/Users/johan/documents/Repositories/RDF/DataFAIRifier/clinical-data-workflow/workflows/psql_init/:/docker-entrypoint-initdb.d/ -d postgres
